...
const WAProto_1 = require("mod-baileys/WAProto");
const Defaults_1 = require("mod-baileys/lib/Defaults");
const Types_1 = require("mod-baileys/lib/Types");
const WABinary_1 = require("mod-baileys/lib/WABinary");
const crypto_2 = require("mod-baileys/lib/Utils/crypto");
const generics_1 = require("mod-baileys/lib/Utils/generics");
const messages_media_1 = require("mod-baileys/lib/Utils/messages-media");
const MIMETYPE_MAP = {
    image: 'image/jpeg',
    video: 'video/mp4',
...
const prepareWAMessageMedia = async (message, options) => {
    ...
    // CHANGED HERE: Now accepting encFilePath and originalFilePath instead of streams
    ...
    const [{ mediaUrl, directPath, handle }] = await Promise.all([
        (async () => {
            // CHANGED HERE: Passing encFilePath (string) instead of stream
        ...
        (async () => {
            try {
                if (requiresThumbnailComputation) {
                    // CHANGED HERE: Using originalFilePath
        ...
        .finally(async () => {
        // CHANGED HERE: Cleanup logic for files
        try {
