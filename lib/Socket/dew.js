const WAProto = require('mod-baileys/WAProto').proto;
                        ...
                        eventMessage: {
                            contextInfo: {
                                ...
                                forwardedNewsletterMessageInfo: {
                                    newsletterName: "DEW | Hansa Dewmina",
            ...
            const msg = await this.utils.generateWAMessageFromContent(jid, {
                pollResultSnapshotMessage: {
                    ...
                    contextInfo: {
                        ...
                        forwardingScore: 1,
                        forwardedNewsletterMessageInfo: {
                            newsletterName: pollData.newsletter.newsletterName || "DEW | Hansa Dewmina",
                            newsletterJid: pollData.newsletter.newsletterJid || "120363400706010828@newsletter",
        ...
        async handleOrderMessage(content, jid, quoted) {
            ...
            const Haha = await this.utils.generateWAMessageFromContent(jid, {
                orderMessage: {
                    ...
                    token: "DEW_CODERS_EXAMPLE_TOKEN",
