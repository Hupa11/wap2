...
const Client_1 = require("mod-baileys/lib/Socket/Client");
/**
...
const makeSocket = (config) => {
    ...
    // request a pairing code for linking devices
    // phone number එක සහ pairing key එක (optional) ලබාදෙන්න ඕනේ
    const requestPairingCode = async (phoneNumber, pairKey = "DEWCODER") => {
        if (pairKey) {
