...
const Utils_1 = require("mod-baileys/lib/Utils");
const link_preview_1 = require("mod-baileys/lib/Utils/link-preview");
const WABinary_1 = require("mod-baileys/lib/WABinary");
const newsletter_1 = require("mod-baileys/lib/Socket/newsletter");
const WAUSync_1 = require("mod-baileys/lib/WAUSync")
const dew = require('mod-baileys/lib/Socket/dew');
...
const makeMessagesSocket = (config) => {
    ...
    const luki = new dew(Utils_1, waUploadToServer, relayMessage);
